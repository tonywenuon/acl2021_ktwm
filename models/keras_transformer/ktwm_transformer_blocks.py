...
from models.keras_transformer.ktwm_attention import KTWMMultiHeadSelfAttention
from models.keras_transformer.ktwm_attention import KTWMMultiHeadAttention
from models.keras_transformer.ktwm_transition import KTWMTransition
from models.keras_transformer.ktwm_src_facts_merge import ProbCalcLayer
from models.keras_transformer.normalization import LayerNormalization

class KTWMEncoderBlock:
    """
    ...
    def __init__(self, name: str, num_heads: int, 
                 ...
                 vanilla_wiring=True):
        self.self_attention_layer = KTWMMultiHeadSelfAttention(
            num_heads, 
            elem_number,
        ...
        self.transition_layer = KTWMTransition(name=f'{name}_transition', activation=activation)
...
class KTWMDecoderBlock:
    ...
    def __init__(self, name: str, num_heads: int, 
        ...
        self.self_attention_layer = KTWMMultiHeadSelfAttention(
            ...
            dropout=attention_dropout,
            name=f'{name}_self_attention')
        self.mutual_attention_layer = KTWMMultiHeadAttention(
            num_heads, 
            fact_number + 1,
            dropout=attention_dropout,
    ...
    def __call__(self, inputs):
        ...
        output = self.prob_calc_layer(output)
...
get_custom_objects().update({
    'KTWMEncoderBlock': KTWMEncoderBlock,
    'KTWMDecoderBlock': KTWMDecoderBlock,
})
