...
class _BaseKTWMMultiHeadAttention(Layer):
    """
...
class KTWMMultiHeadAttention(_BaseKTWMMultiHeadAttention):
    """
...
class KTWMMultiHeadSelfAttention(_BaseKTWMMultiHeadAttention):
    """
...
get_custom_objects().update({
    'KTWMMultiHeadSelfAttention': KTWMMultiHeadSelfAttention,
    'KTWMMultiHeadAttention': KTWMMultiHeadAttention,
})
